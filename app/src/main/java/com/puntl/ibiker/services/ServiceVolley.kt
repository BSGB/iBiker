...
class ServiceVolley {
    ...
    fun callApi (path: String, method: Int, params: JSONObject, tag: String, customHeaders: HashMap<String, String>, completionHandler: (response: JSONObject?) -> Unit, errorHandler: (error: VolleyError) -> Unit) {
